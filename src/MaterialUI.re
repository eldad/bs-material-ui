...
module BottomNavigationAction = {
  ...
  external makeProps :
    (
      ...
      ~onKeyboardFocus: ReactEvent.Focus.t => unit=?,
  ...
  let make =
      (
        ...
        ~onKeyboardFocus: option(ReactEvent.Focus.t => unit)=?,
...
module Checkbox = {
  ...
  external makeProps :
    (
      ...
      ~onChange: (ReactEvent.Selection.t, bool) => unit=?,
      ~_type: string=?,
      ~value: string=?,
      ~classes: Js.Dict.t(string)=?,
      ~style: ReactDOMRe.style=?,
  ...
  let make =
      (
        ...
        ~onChange: option((ReactEvent.Selection.t, bool) => unit)=?,
        ~_type: option(string)=?,
        ~value: option(string)=?,
        ~classes: option(Classes.t)=?,
        ~style: option(ReactDOMRe.style)=?,
...
module Input = {
  ...
  external makeProps :
    (
      ...
      ~onBlur: ReactEvent.Focus.t => unit=?,
      ~onChange: ReactEvent.Form.t => unit=?,
      ~onEmpty: ReactEvent.Synthetic.t => unit=?,
      ~onFilled: ReactEvent.Synthetic.t => unit=?,
      ~onFocus: ReactEvent.Focus.t => unit=?,
      ~onKeyDown: ReactEvent.Keyboard.t => unit=?,
      ~onKeyUp: ReactEvent.Keyboard.t => unit=?,
      ~placeholder: string=?,
  ...
  let make =
      (
        ...
        ~onBlur: option(ReactEvent.Focus.t => unit)=?,
        ~onChange: option(ReactEvent.Form.t => unit)=?,
        ~onEmpty: option(ReactEvent.Synthetic.t => unit)=?,
        ~onFilled: option(ReactEvent.Synthetic.t => unit)=?,
        ~onFocus: option(ReactEvent.Focus.t => unit)=?,
        ~onKeyDown: option(ReactEvent.Keyboard.t => unit)=?,
        ~onKeyUp: option(ReactEvent.Keyboard.t => unit)=?,
...
module TablePagination = {
  ...
  external makeProps :
    (
      ...
      ~onChangePage: (Js.Nullable.t(ReactEvent.Synthetic.t), int) => unit,
